...
async function openOrder(id){
  ...
  if(order.zipBytes>1024**3&&!state.helperBatches)throw new Error('Large orders need Print Helper 1.1.0 or newer. Reload the updated extension in edge://extensions or chrome://extensions, then reload this page. For a separately extracted helper, update its files first.');
