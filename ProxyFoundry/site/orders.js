...
async function openOrder(id){
  ...
  if(order.zipBytes>1024**3&&(state.helperProtocol||1)<2)throw new Error('This order needs the multi-ZIP print helper (1.1.0 or newer). Update the files in your installed extension folder, click Reload on its Edge/Chrome extension card, and reload this page.');
