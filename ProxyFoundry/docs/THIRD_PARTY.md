...
Proxy Foundry integrates the user's approved Card Tools v48 source, preserved in `vendor/card_tools`. Its native template assets and original project notices remain in those files.
